...
function ItemCount({stock, initial, onAdd}) {
    ...
    function add(){ count ? setCount(count - 1) : setCount(0) }
    function remove(){ count < stock ? setCount(count + 1) : setCount(count) }
    function toOnAdd(){
        ...
        <div className="container-itemCount">
            ...
            <div className="container-description">
                ...
                <div className="container-btnCart">
                    <button onClick={()=> add() } className="btn-remove">-</button>
                    <h2 className="count">{count}</h2>
                    <button onClick={()=> remove() } className="btn-add">+</button>
                </div>
